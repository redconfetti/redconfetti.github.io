...
The _Set_ object stores **unique** values of **any type**, whether primitive values or object references.
...
The _default_ keyword allows this class to be set to any variable name once it’s imported.
